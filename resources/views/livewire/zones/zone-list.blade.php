            ...
            @foreach($zones as $zone)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="p-3 border text-center space-x-3">
                        <a href="{{ route('agences.zones.show', $zone) }}" class="text-indigo-600 hover:underline" wire:navigate>Détails</a>
                        <a href="{{ route('agences.zones.edit', $zone->uuid) }}" class="text-indigo-600 hover:underline" wire:navigate>Modifier</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
