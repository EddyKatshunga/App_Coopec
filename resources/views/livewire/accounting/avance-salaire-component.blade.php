{{-- resources/views/livewire/accounting/avance-salaire-component.blade.php --}}
<div class="p-6 sm:p-8 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        <!-- En-tête avec infos Agence/Journée -->
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Avance sur salaire</h1>
                <p class="text-sm text-slate-500">Enregistrement des avances aux employés</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="employe_nom" class="block text-sm font-semibold text-slate-700 mb-2">Employé</label>
                        <input type="text" wire:model="employe_nom" id="employe_nom" placeholder="Nom de l'employé"
                        ...
                        @error('employe_nom') <span class="text-rose-500 text-xs mt-1 italic">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <!-- Libellé -->
                    <div class="md:col-span-2">
                        <label for="libelle" class="block text-sm font-semibold text-slate-700 mb-2">Description / Libellé (Optionnel)</label>
                        <textarea wire:model="libelle" id="libelle" rows="2" 
                                  placeholder="Ex: Avance sur salaire pour frais médicaux..."
                ...
                <div class="pt-4">
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="save">Enregistrer l'avance</span>
