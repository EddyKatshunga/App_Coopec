{{-- resources/views/livewire/accounting/produit-component.blade.php --}}
<div class="p-6 sm:p-8 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        <!-- En-tête avec infos Agence/Journée -->
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Enregistrement d'un Produit</h1>
                <p class="text-sm text-slate-500">Saisissez les détails du revenu ci-dessous.</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="account_id" class="block text-sm font-semibold text-slate-700 mb-2">Nature du produit / revenu</label>
                        <select wire:model="account_id" id="account_id" 
                            ...
                            @foreach($comptesProduit as $compte)
                    ...
                    <!-- Mode de réception -->
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Mode de réception</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea wire:model="libelle" id="libelle" rows="2" 
                                  placeholder="Ex: Vente de 50 carnets, Frais d'adhésion, Intérêts perçus..."
                ...
                <div class="pt-4">
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="save">Enregistrer le produit</span>
