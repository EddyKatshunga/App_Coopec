<div class="p-6 sm:p-8 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Enregistrement d'une Charge</h1>
                <p class="text-sm text-slate-500">Saisissez les détails de la dépense ci-dessous.</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="account_id" class="block text-sm font-semibold text-slate-700 mb-2">Nature de la charge</label>
                        <select wire:model="account_id" id="account_id" 
                            ...
                            @foreach($comptesCharge as $compte)
                ...
                <div class="pt-4">
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="save">Enregistrer la dépense</span>
