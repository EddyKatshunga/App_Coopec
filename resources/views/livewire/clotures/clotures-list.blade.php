        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-50">
                    <td class="py-3 px-6 font-medium">{{ $cloture->date_cloture->isoFormat('dddd D MMMM YYYY') }}</td>
                    <td class="py-3 px-6">
                    ...
                    <td class="py-3 px-6 text-right font-mono">${{ number_format_fr($cloture->report_coffre_usd, 'USD')}}</td>
                    <td class="py-3 px-6 text-right font-mono">{{ number_format_fr($cloture->report_coffre_cdf, 'CDF') }} FC</td>
                    <td class="py-3 px-6 text-center flex justify-center space-x-2">
                        <a href="{{ route('clotures.show', $cloture) }}" wire:navigate class="text-blue-500 hover:text-blue-700">
