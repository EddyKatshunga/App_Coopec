<div class="p-6 bg-white rounded-lg shadow">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('revenus.create') }}" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Nouveau Revenu</a>
    </div>
            ...
            @foreach($revenus as $revenu)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="p-3 border text-center space-x-3">
                        <a href="{{ route('revenus.show', $revenu->id) }}" class="text-blue-500 hover:text-blue-700">Détails</a>
